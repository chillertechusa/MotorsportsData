  ...
  return (
    <section id="pricing" className="border-t border-zinc-800 bg-zinc-950 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-12 grid gap-px border border-zinc-800 bg-zinc-800 md:grid-cols-2 lg:grid-cols-4">
          {/* Rider — free */}
          ...
          {/* Rider Pro */}
          <div className="relative flex flex-col gap-6 bg-zinc-950 p-8 outline outline-1 -outline-offset-1 outline-green-500">
            <div className="absolute right-4 top-4 bg-green-500 px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-widest text-zinc-950">
              Collects the money
            </div>
            <div>
              <div className="font-mono text-xs uppercase tracking-widest text-green-500">Rider Pro</div>
              <div className="mt-2 flex items-baseline gap-2">
            ...
            <Link
              href="/auth/sign-up"
              className="inline-flex items-center justify-center bg-green-500 px-6 py-3 font-mono text-sm font-bold uppercase tracking-widest text-zinc-950 transition-colors hover:bg-green-400"
            >
              Get Pro
            </Link>
          </div>
          ...
          <div className="flex flex-col gap-6 bg-zinc-950 p-8">
            <div>
              <div className="font-mono text-xs uppercase tracking-widest text-zinc-400">Shops, Teams &amp; Brands</div>
              <div className="mt-2 flex items-baseline gap-2">
