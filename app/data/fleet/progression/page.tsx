...
import { ProgressionTracker } from '@/components/data/progression-tracker'

export const metadata: Metadata = {
  title: 'Ride Progression — Motorsport Data',
  description: 'Track lap times and improvement trends across all your sessions.',
}
...
export default async function ProgressionPage() {
    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-zinc-400 mb-6">Add a vehicle to your fleet to start tracking progression.</p>
  ...
  return <ProgressionTracker vehicles={vehicles} teamId={teamId} />
}
