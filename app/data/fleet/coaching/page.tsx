...
import { CoachingDashboard } from '@/components/data/coaching-dashboard'

export const metadata: Metadata = {
  title: 'Race Coach AI — Motorsport Data',
  description: 'Get personalized coaching feedback and race analysis from AI.',
}
...
export default async function CoachingPage() {
    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-zinc-400 mb-6">Add a vehicle to your fleet to access Race Coach AI.</p>
  ...
  return <CoachingDashboard vehicles={vehicles} />
}
