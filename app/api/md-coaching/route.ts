...
${setupSummary || 'No setup data recorded'}`
    ...
    void logAICall({ route: 'md-coaching', model: COACHING_MODEL, inputTokens: result.usage.inputTokens ?? 0, outputTokens: result.usage.outputTokens ?? 0, latencyMs: Date.now() - t0, finishReason: result.finishReason, teamId: authResult.teamId })
