...
${JSON.stringify(context, null, 2)}`
    ...
    void logAICall({ route: 'md-coach', model: MD_COACH_MODEL, inputTokens: usage.inputTokens ?? 0, outputTokens: usage.outputTokens ?? 0, latencyMs: Date.now() - t0, finishReason, teamId: authResult.teamId })
